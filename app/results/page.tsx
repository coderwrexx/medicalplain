      ...
      <div className="max-w-3xl mx-auto p-4">
        ...
        <div className="mb-8">
             <button
              ...
              className="w-full bg-gray-800 text-white font-semibold py-3 rounded-xl text-sm hover:bg-gray-900 disabled:opacity-50 transition-all flex items-center justify-center gap-2"
            >
              {isGeneratingPDF ? (
                <>
